...
app.post('/reset-password', valid.validateEmail, getUserbyEmail, email.sendReset);
app.patch('/reset-password/:token', valid.validatePass, email.resetPass);
...
app.put('/role', valid.checkRole, checkAdmin, UserMiddle.getUserbyEmail, isUserVerified, role.changeRole);
